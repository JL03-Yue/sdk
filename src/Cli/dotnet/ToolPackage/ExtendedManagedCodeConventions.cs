...
namespace NuGet.Client
{
    ...
    /// </summary>
    public class ExtendedManagedCodeConventions: ManagedCodeConventions
    {
        ...
        public ExtendedManagedCodeConventions(RuntimeGraph runtimeGraph): base(runtimeGraph)
        {
           ...
           ExtendedProperties = new ReadOnlyDictionary<string, ContentPropertyDefinition>(props);
        ...
        public class ExtendedManagedCodeCriteria
        {
            ...
            internal ExtendedManagedCodeCriteria(ManagedCodeConventions conventions)
            {
        ...
        public class ExtendedManagedCodePatterns
        {
            ...
            internal ExtendedManagedCodePatterns(ManagedCodeConventions conventions)
            {
